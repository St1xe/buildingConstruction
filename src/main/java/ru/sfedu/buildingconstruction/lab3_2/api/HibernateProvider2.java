...
import ru.sfedu.buildingconstruction.lab3_2.model.Building;
import ru.sfedu.buildingconstruction.lab3_2.util.HibernateUtil;


public class HibernateProvider2 {

    private static Logger log = Logger.getLogger(HibernateProvider2.class);
    ...
    public void deleteAllRecordsFromTable() {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            session.createMutationQuery(Constants.DELETE_ALL_RECORDS_FROM_LAB_3_2).executeUpdate();
