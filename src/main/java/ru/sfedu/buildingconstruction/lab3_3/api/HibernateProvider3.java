...
import ru.sfedu.buildingconstruction.lab3_3.model.Building;
import ru.sfedu.buildingconstruction.lab3_3.util.HibernateUtil;


public class HibernateProvider3 {

    private static Logger log = Logger.getLogger(HibernateProvider3.class);
    ...
    public void deleteAllRecordsFromTable() {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            session.createMutationQuery(Constants.DELETE_ALL_RECORDS_FROM_LAB_3_3).executeUpdate();
