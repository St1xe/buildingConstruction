...
import ru.sfedu.buildingconstruction.lab3_4.model.Building;
import ru.sfedu.buildingconstruction.lab3_4.util.HibernateUtil;


public class HibernateProvider4 {

    private static Logger log = Logger.getLogger(HibernateProvider4.class);
    ...
    public void deleteAllRecordsFromTable() {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            session.createMutationQuery(Constants.DELETE_ALL_RECORDS_FROM_LAB_3_4).executeUpdate();
