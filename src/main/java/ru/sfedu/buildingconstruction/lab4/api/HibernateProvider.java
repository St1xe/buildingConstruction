...
import ru.sfedu.buildingconstruction.lab4.util.HibernateUtil;


public class HibernateProvider {

    private static final Logger log = Logger.getLogger(HibernateProvider.class);
    ...
    public void deleteAllRecordsFromTable() {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            session.createMutationQuery(Constants.DELETE_ALL_RECORDS_FROM_LAB_4).executeUpdate();
